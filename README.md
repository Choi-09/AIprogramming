...
<div>
  <img src="../PythonMLWorkspace/images/linearRegression.png" align = 'left' width = 40%>
</div> <br>
...
<div >
  <img src="../PythonMLWorkspace/images/one.png" align = 'left'>
</div>
...
#### 3-1) 시그모이드 함수
<div >
  <img src="../PythonMLWorkspace/images/sig.png" align = 'left' width = 30%>
</div>
<div >
  <img src="../PythonMLWorkspace/images/graph1.png" align = 'left' width = 30%>
</div>
  
#### 3-2) 혼동행렬
<div >
  <img src="../PythonMLWorkspace/images/confusion.png" align = 'left' width = 30%>
</div>
...
+ 군집화(clustering): 유사한 특징을 가지는 데이터들을 그룹화
...
<div >
  <img src="../PythonMLWorkspace/images/euclidean1.png" align = 'left' width = 30%>
</div>
  
#### > Manhattan Distance 맨해튼 거리
+ 두 지점을 계단식으로 잇는 것 <br/>
<div >
  <img src="../PythonMLWorkspace/images/menhattan.png" align = 'left' width = '30%'>
</div>
  
#### > Cosine Similarity 코사인 유사도
+ 지점들간의 각도. 각도가 작을 수록 유사도가 높다고 본다. <br/>
<div >
  <img src="../PythonMLWorkspace/images/cosine.png" align = 'left' width = 30%>
</div>
